...
UNLOCK_CODE = "VodyXxvfmdi2253ealgrdj"  # Le code pour débloquer

# ================== COULEURdS & STYLESc (DESIGN) ==================
RED = "\033[91m"
GREEN = "\033[92m"
YELLOW = "\033[93m"
BLUE = "\033[94m"
...
PAUSE_VIDEO = "200 500"
LIKE_BUTTON = "665 1015"
FOLLOW_BUTTON = "212 477"
SWIPE_REFRESH = "572 320 572 585 572"
...
class TikTokTaskBot:
    ...
    def update_script(self):
        ...
        url = "https://raw.githubusercontent.com/MichelPrincy/mhjoy/main/main.py"
        try:
    ...
    async def do_task(self, account_idx, link, action):
        try:
            self.cleanup_apps()
            coord_clone = APP_CHOOSER.get(account_idx, "100 1166")
